...
//======================================================================================//
    ...
    static void tampilkanRingkasanEng() 
    {
        ...
        System.out.println(  "|                Film: " + filmTerpilih + spaces(50 - (String.valueOf(filmTerpilih).length() + 22)) + "|");
        System.out.println(  "|                Studio: " + getStudioTerpilih() + spaces(50 - (getStudioTerpilih().length() + 24)) + "|");
        System.out.println(  "|                Total Ticket: " + jumlahTiket + spaces(50 - (String.valueOf(jumlahTiket).length() + 30)) + "|");
    ...
    static void prosesPembayaranEng() 
    {
        ...
        {
            System.out.println("|==================================================|");
            System.out.println("|   Payment successful. Tickets have been booked!  |");
            System.out.println("|==================================================|");
            System.out.println("                                                    ");
    ...
    static void tampilkanHistoryTransaksiEng() {
        ...
        System.out.println("| Kasir 2:                                         |");
        for (int i = 0; i < indexHistoryKasir2; i++) {
            System.out.println("| > Transaction " + (i + 1) + ": Total Ticket = " + historyJumlahTiketKasir2[i] +
                    spaces(51 - (String.valueOf(historyJumlahTiketKasir2[i]).length()+32)) + "|");
            System.out.println("|                Revenue = " + historyPendapatanKasir2[i] +
                    spaces(51 - (String.valueOf(historyPendapatanKasir2[i]).length()+30)) + "|");
          System.out.println("|" + spaces(50) + "|");
        }
        System.out.println("|==================================================|");
    ...
    static void tampilkanHistoryTransaksiAllEng() {
        ...
        for (int i = 0; i < indexHistory; i++) {
            System.out.println("| > Transaction " + (i + 1) + ": Film = " + historyFilm[i] +
                    spaces(50 - (historyFilm[i].length() + 23)) +
                    "|");
            System.out.println("|                Studio = " + historyStudio[i] +
                    spaces(50 - (historyStudio[i].length() + 25)) +
                    "|");
            System.out.println("|                Total Tiket = " + historyJumlahTiket[i] +
                    spaces(50 - (String.valueOf(historyJumlahTiket[i]).length() + 31)) +
                    "|");
            System.out.println("|                Revenue = " + historyPendapatan[i] +
                    spaces(50 - (String.valueOf(historyPendapatan[i]).length() + 29)) +
                    "|");
            System.out.println("|                                                  |");
        }
    ...
    static void PemilihanFILMEng() {
        ...
        do {
            System.out.println("|==================================================|");
            System.out.print("|   Choose the movie number you want to watch: ");
            jdlinput = inputUntukJdlFilm.nextInt();
            ...
            else 
            {
                System.out.println("                                                    ");
                System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<");
                System.out.println("      The movie number you entered is not valid.    ");
                System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<");
                System.out.println("                                                    ");
            }
        } while (jdlinput < 1 || jdlinput > jdl_film.length);
 ...
 static void PemilihanStudioWishEng(){
        // Pilih Studio
        System.out.println("|==================================================|");
        System.out.println("|            List of Available Studios:            |");
        System.out.println("|==================================================|");
        for (int i = 0; i < studioWISH.length; i++) {
        ...
        System.out.println("                                                    ");
        System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<");        
        System.out.println("     The studio number you entered is not valid.    ");
        System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<");
        System.out.println("                                                    ");
    ...
    static void PemilihanStudioTheMarvelsEng(){
        ...
        for (int i = 0; i < studioTheMarvels.length; i++) 
        {
        System.out.println(  "|             " + (i + 1) + ". " + studioTheMarvels[i] + " (Price: " + hrg_stdTheMarvels[i]+")" + spaces(51 - (studioTheMarvels[i].length() + String.valueOf(hrg_stdTheMarvels[i]).length() + 27))+"|");
        System.out.println("|==================================================|");
        }
        System.out.print(  "|             Choose the studio number: ");
        studioInput = inputUntukStudio.nextInt();
        ...
        studioInput--; // Mengurangi 1 karena array dimulai dari 0
        System.out.println("|==================================================|");
        System.out.println(  "|        The studio your selected: " + studioTheMarvels[studioInput] + spaces(51 - (studioTheMarvels[studioInput].length() + 33))+ "|");
        System.out.println("|==================================================|");
        } 
        else 
        {
    ...
    static void PemilihanStudioNapoleonEng(){
        ...
        for (int i = 0; i < studioNapoleon.length; i++) 
        {
        System.out.println(  "|             " + (i + 1) + ". " + studioNapoleon[i] + " (price: " + hrg_stdNapoleon[i]+")" + spaces(51 - (studioNapoleon[i].length() + String.valueOf(hrg_stdWISH[i]).length() + 27))+"|");
        System.out.println("|==================================================|");
        }
        System.out.print("|Choose the studio number: ");
        studioInput = inputUntukStudio.nextInt();
        ...
        studioInput--; // Mengurangi 1 karena array dimulai dari 0
        System.out.println("|==================================================|");
        System.out.println(  "|        The studio your selected: " + studioNapoleon[studioInput] + spaces(51 - (studioNapoleon[studioInput].length() + 33))+ "|");
        System.out.println("|==================================================|");
        } 
        else 
        {
    ...
    static void PemilihanKursiStudioDeluxeWishEng(){
        System.out.println("____________________________________________________");
        System.out.println("|Studio         |      SCREEN      |               |");
        System.out.println("|Deluxe         ===================                |");
        System.out.println("|                                                  |");
        for (int i = 0; i < 5; i++) {
            char barisHuruf = (char) ('A' + i);
        ...
        {     
            ...
            char barisHurufInput = inputUntukPilihKursi.next().charAt(0);
            int baris = barisHurufInput - 'A' + 1;
            System.out.print("|   Choose seat column (1-5) and 0 to cancel: ");
            int kolom = inputUntukPilihKursi.nextInt();
            ...
            if (barisHurufInput == '0' || kolom == 0) 
            {
                System.out.println("                                                    ");
                System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<");
                System.out.println("        The seat selection has been cancel.         ");
                System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<");   
                System.out.println("                                                    ");        
                isPemilihanDibatalkan = true;
                break; // Jika pembatalan, keluar dari loop
            ...
            else if (baris >= 1 && baris <= 5 && kolom >= 1 && kolom <= 5) 
            {
                ...
                {
                    StudioDeluxeWish[baris - 1][kolom - 1] = 'X'; // Menandai kursi sebagai terisi ('X')
                    kursiTerpilih[indexKursiTerpilih] = "|                (Row " + barisHurufInput + " - Column " + kolom + ")               |";
                    System.out.println("|==================================================|");
                    indexKursiTerpilih++;
                    System.out.println("|     You have selected seats in row  " + barisHurufInput + ", Column " + kolom + "    |");
                } 
                else 
                {
                    System.out.println("|--------------------------------------------------|");
    ...
    static void PemilihanKursiStudioIMAXTheMarvelsEng(){
        ...
        System.out.println("|_______|1|_____|2|_____|3|_____|4|_____|5|________|");
        System.out.println("|==================================================|");
        System.out.println("|     Please choose seats for the IMAX Studio:     |");
        for (int i = 0; i < jumlahTiket; i++)
        {     
            System.out.println("|--------------------------------------------------|");
            System.out.println("|                   Seat number-" + (i + 1) + ". " + "                  |");
    ...
    static void PemilihanKursiStudioDeluxeTheMarvelsEng(){
        ...
        {   
            ...
            if (barisHurufInput == '0' || kolom == 0) 
            {
                System.out.println("                                                    ");
                System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<");
                System.out.println("         The seat selection has been canceled       ");
                System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<");   
                System.out.println("                                                    ");
                isPemilihanDibatalkan = true;             
                break; // Jika pembatalan, keluar dari loop
    ...
    static void PemilihanKursiStudioThePremiereNapoleonEng(){
        ...
        System.out.println("|_______|1|_____|2|_____|3|_____|4|_____|5|________|");
        System.out.println("|==================================================|");
        System.out.println("|   Please choose seats for The Premiere Studio:   |");        
        for (int i = 0; i < jumlahTiket; i++)
        {     
            System.out.println("|--------------------------------------------------|");
            System.out.println("|                  Seat number-" + (i + 1) + ". " + "                  |");
